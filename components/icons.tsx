...
//MONITOR ICON
export const MonitorIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
   <svg
      aria-hidden='true'
      focusable='false'
      width={size || width}
...
// SETTING ICON
export const SettingIcon = ({ size = 20, width, height, ...props }: IconSvgProps) => (
   <svg
      aria-hidden='true'
      focusable='false'
      height={size || height}
